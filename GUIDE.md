...
This project appreciates [firstcontribution](https://github.com/firstcontributions/first-contributions) community to support beginners like me. I'm excited to add their steps here which I have also followed earlier.
...
```
git clone https://github.com/this-is-you/Javascript-Basic-Explanations.git
```
...
```
cd Javascript-Basic-Explanations
```
...
```
git commit -m "A simple message about your changes"
```
